[
		{
			...
			"respons": "I am responsible for refactoring all CSS files for Target Mobile to fit into the new framework that is being contracted. The framework is being built using Backbone; other developers are creating namespaces for individual aspects of Target Mobile; it is these namespaces that the CSS I am building fits into. My goal is to create as many global items as possible so other developers can reuse our code for future projects and reduce code bloat.",
			...
			"posComp": "Polaris",
		 	"posTitle": "Jr Front-End Developer",
		  	"posDates": "June - October 2013",
		   	"respons": "I was responsible for creating all functionality and content for the drop down menus that can be found across all product sites (RZR, Ranger, Victory and Indian). Senior developers created templates through Knockout, which I would invoke whenever a user moused over the appropriate link.",
		   	"accomp": "I was part of a three person team that created the new navigation system and Ecom Integration. Our goal was to create a better experience for users looking for new products.",
